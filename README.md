...
![主页：浮玉四时入口、四季导览面板、浮玉客提问入口](docs/images/home.png)

### 题咏志（题咏检索与筛选）

![题咏志：按题名、正文、作者检索题咏，支持按季节、研究范围与版式筛选](docs/images/archive.png)

### 作品详情（著录、文本、研究状态）

![作品详情：原诗、作者、著录、研究状态、相关影像清单](docs/images/work-detail.png)

### 影像对读（古籍扫描与文本并列）

![影像对读：左侧古籍扫描、右侧文本与笔读，呈现原迹与释读对应关系](docs/images/facsimile.png)

### 浮玉客（题咏导览问答）

![浮玉客：AI 模式导览，结合研究范围给出答案并附引文](docs/images/agent.png)
